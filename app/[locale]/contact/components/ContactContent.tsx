					...
					<div className="space-y-8">
						<div className="bg-blue-50/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
							...
							<div className="space-y-6">
								<div
									className={`flex items-center group hover:scale-105 transition-transform space-x-4`}>
									<Mail className="w-6 h-6 text-blue-600 group-hover:scale-110 transition-transform" />
									<div>
										<p className={`font-semibold text-blue-900 `}>
											{t("email")}
										</p>
										<p className={`text-gray-600 `}>hello@eshark.com</p>
									</div>
								</div>
								<div
									className={`flex items-center group hover:scale-105 transition-transform space-x-4`}>
									...
									<div>
										...
										<p className={`text-gray-600 `}>+20 122 925 4999</p>
									</div>
								</div>
								<div
									className={`flex items-center group hover:scale-105 transition-transform space-x-4`}>
						...
						<div className="bg-orange-50/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
							...
							<div className="space-y-3">
								<button
									className={`w-full bg-blue-600 text-white py-3 px-6 rounded-lg hover:bg-blue-700 transition-all duration-300 hover:scale-105 hover:shadow-lg  
                  }`}>
									{t("scheduleDemo")}
								</button>
								<button
									className={`w-full border border-blue-600 text-blue-600 py-3 px-6 rounded-lg hover:bg-blue-50 transition-all duration-300 hover:scale-105 hover:shadow-lg  
                  }`}>
									{t("helpCenter")}
								</button>
							</div>
