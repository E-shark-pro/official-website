...
const FAQHeader = ({ title, subtitle }) => (
  ...
  //   <span className="mb-8 bg-gradient-to-r from-primary to-primary bg-clip-text font-medium text-transparent">
  //     {subtitle}
  //   </span>
  ...
  <SectionTitle title={title} preTitle={subtitle} />
);
...
const FAQList = ({ faqData, selected }) => {
  const [openIndex, setOpenIndex] = useState<number | null>(null); // track which is open
...
// FAQItem now gets isOpen and onClick as props
